...
A Claude Skill that builds and maintains a sourced, dated timeline of a regulatory, legislative, or litigation development, and is designed to accumulate history across sessions, not just produce a one-time snapshot.
